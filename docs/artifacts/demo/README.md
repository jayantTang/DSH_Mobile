...
| 文件 | 内容 |
|---|---|
| `overview.jpg` | **README 用的横版**：把下面四张按 2×2 顺序横向拼成一张（2048×1112，251 KB） |
...
入库时统一缩到 480px 宽、JPEG 质量 82，单张 66–85 KB；`overview.jpg` 由这四张原图用
`ffmpeg -filter_complex "[0:v][1:v][2:v][3:v]hstack=inputs=4,scale=2048:-2"` 拼出（拼的是原始 1320×2868，
不是入库的缩略图，否则放大后会糊）。
